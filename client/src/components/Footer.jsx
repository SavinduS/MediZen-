                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <span className="text-xl font-bold text-white tracking-tight">MediZen</span>
                        </div>
                        <p className="text-sm leading-relaxed">
                            Revolutionizing healthcare through AI-driven diagnostics and seamless telemedicine connectivity.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><a href="/symptoms" className="hover:text-blue-400 transition-colors">AI Symptom Checker</a></li>
                            <li><a href="/doctors" className="hover:text-blue-400 transition-colors">Find Doctors</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li className="flex items-center gap-2"><Mail size={14} /> support@medizen.com</li>
                            <li className="flex items-center gap-2"><Phone size={14} /> +1 (555) 000-ZEN</li>
                        </ul>
                    </div>
